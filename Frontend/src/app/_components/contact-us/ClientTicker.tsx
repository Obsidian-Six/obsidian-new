    ...
    <div className="w-full bg-white py-6 md:py-12 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 mb-12 md:mb-20 text-center">
        <motion.span 
          ...
          viewport={{ once: true }}
          className="text-[#052D69] font-mono text-[10px] md:text-xs tracking-[0.4em] uppercase block font-bold mb-4"
        >
          [ Trusted Partners ]
        </motion.span>
        <motion.h2 
        ...
        >
          Behind Every Great <span className="italic font-serif text-[#052D69]">Strategy</span>, <br className="hidden md:block" />
          There’s a Great <span className="italic font-serif text-[#052D69]">Team</span>.
        </motion.h2>
      </div>
        ...
        >
          {tickerLogos.map((logo, index) => (
            ...
            >
              ...
              <div className="relative h-20 md:h-32 w-36 md:w-60 flex items-center justify-center bg-gray-50/40 rounded-xl md:rounded-2xl border border-gray-100 transition-all duration-500 hover:bg-white hover:shadow-[0_20px_40px_-15px_rgba(90,0,236,0.1)] hover:border-[#052D69]/20">
