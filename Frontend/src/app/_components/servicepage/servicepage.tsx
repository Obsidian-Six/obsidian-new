          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="lg:col-span-4 space-y-3">
                <span className="inline-block bg-[#052D69] text-white text-[9px] font-black px-2.5 py-1 rounded-sm uppercase tracking-[0.2em]">
              ...
              <div className="lg:col-span-3">
                {/* Removed group-hover:shadow-[#052D69]/5 to stop shadow change on hover */}
