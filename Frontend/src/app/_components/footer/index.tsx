...
const Footer = () => {
  ...
  const isSecureRoute =
    pathname?.startsWith("/secure") || pathname?.startsWith("/hidden-document");
        ...
        <div className="os-inner">
          <div className="os-cta">
            <div>
              ...
              <h2>
                Let&apos;s construct your <span>future</span>, together.
              </h2>
            </div>
          ...
          <div className="os-main">
            <div className="os-brand-col">
              ...
              <div className="os-social-row">
                <a
                  href="https://www.instagram.com/obsidiansixofficial"
                  target="_blank"
                ...
                >
                  <svg
                    ...
                    strokeWidth="1.8"
                  >
                    <path d="M6.5 9.5v9"></path>
                    <circle cx="6.5" cy="6" r="1.4"></circle>
                    <path d="M11 18.5v-5.2c0-1.8 1.1-3.1 2.8-3.1 1.7 0 2.7 1.2 2.7 3.1v5.2"></path>
                    <path d="M11 9.5v9"></path>
                  </svg>
                </a>
                <a
                ...
                >
                  <svg
                    ...
                    strokeWidth="1.8"
                  >
                    <path d="M7 17l-1.4 3.4L9 19a8 8 0 1 0-3.4-3.1Z"></path>
                    <path d="M9 9.5c0 3 2.5 5.5 5.5 5.5"></path>
                  </svg>
                </a>
              </div>
            </div>
            ...
            <div className="os-col">
              ...
              <ul>
                ...
                <li>
                  <Link href="/digital-marketing-agency-uae">
                    Digital Marketing
                  </Link>
                </li>
                <li>
                  <Link href="/branding-agency-uae">Branding</Link>
                </li>
              </ul>
            </div>
            ...
            <div className="os-col">
              ...
              <div className="os-office">
                ...
                <p className="os-office-addr">
                  Platinum BKC, 3rd Floor,
                  <br />
            ...
            <div className="os-col">
              ...
              <div className="os-contact-block">
                ...
                <Link className="os-contact-value" href="tel:+918085652729">
                  +91 80856 52729
                </Link>
              </div>
              <div className="os-contact-block">
                <p className="os-contact-label">HR &amp; careers</p>
                <Link className="os-contact-value" href="tel:+918982992729">
                  +91 89829 92729
                </Link>
              </div>
              <div className="os-contact-block">
              ...
              <div className="mt-4">
                <Link
                  ...
                  className="text-slate-400 hover:text-white transition-colors duration-300 text-[11px] font-bold uppercase tracking-wider underline inline-flex items-center gap-1"
                >
