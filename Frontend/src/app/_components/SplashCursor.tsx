...
export default function SplashCursor(props: SplashCursorProps) {
  ...
  useEffect(() => {
    ...
    // Completely disable liquid cursor on mobile/tablet
    if (isMobile) {
    ...
    function createProgram(
      ...
      // Keep the fullscreen quad attribute stable across WebGL implementations.
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-[9999] h-full w-full">
      <canvas
        ref={canvasRef}
        id="fluid"
