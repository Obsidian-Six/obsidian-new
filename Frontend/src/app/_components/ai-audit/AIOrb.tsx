...
export default function AIOrb({
  ...
  useEffect(() => {
    ...
    const handlePointerMove = (
      ...
      /*
       * Only activate when pointer
       * is actually over the orb.
       */
      targetHover =
        distance < 0.85
          ? 1
    ...
    const render = (time: number) => {
      ...
      if (
        settings.rotateOnHover &&
        currentHover > 0.01
      ) {
        /*
         * Rotation continues while hovering.
         * This is what makes the orb feel alive.
         */
        currentRot +=
          dt *
          rotationSpeed *
