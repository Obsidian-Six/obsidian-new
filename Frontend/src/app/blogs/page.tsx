...
return (
  <section className="relative min-h-screen bg-white pt-20 md:pt-32 lg:pt-40 pb-12 md:pb-24 overflow-hidden">
    ...
    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-80 md:h-200 -z-10 pointer-events-none">
      <div className="absolute top-[-5%] left-[-5%] w-[80%] md:w-[40%] h-[40%] rounded-full bg-[#052D69]/5 blur-[60px] md:blur-[120px]" />
    </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10">
      <header className="relative z-10 mb-8 md:mb-12">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tighter text-slate-900 leading-[0.95] md:leading-[0.9] mb-8 text-center md:text-left">
          ...
          <span className="text-transparent bg-clip-text bg-linear-to-r from-[#052D69] to-blue-400">
            Perspectives.
          </span>
        </h1>
        ...
        <div className="relative w-full max-w-xl mx-auto md:mx-0 mb-6 group">
          <input
            ...
            className="w-full px-5 py-3.5 md:px-6 md:py-4 bg-slate-50 border border-slate-200 rounded-xl md:rounded-2xl focus:outline-none focus:ring-4 focus:ring-[#052D69]/10 focus:border-[#052D69] transition-all text-base text-slate-800 placeholder:text-slate-400"
          />
          <div className="absolute right-4 md:right-5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#052D69]">
      ...
      <div className="relative z-10">
        {loading ? (
          <div className="py-20 md:py-24 text-center flex flex-col items-center gap-4">
            <div className="w-8 h-8 md:w-10 md:h-10 border-4 border-slate-100 border-t-[#052D69] rounded-full animate-spin"></div>
          ...
          <div className="py-16 md:py-24 px-6 text-center border-2 border-dashed border-slate-100 rounded-2xl md:rounded-3xl bg-slate-50/50">
            ...
            <button 
              ...
              className="mt-4 text-[#052D69] font-bold underline decoration-2 underline-offset-4"
            >
              Reset all filters
            </button>
          </div>
