    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-12 xl:px-20 z-20 relative mt-16">
        <motion.div
          ...
          className="max-w-4xl"
        >
          <span className="text-[#FD7B28] text-xs font-bold uppercase tracking-[0.4em] mb-4 block font-poppins drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]">
            [ Portfolio ]
          </span>
          ...
          <p className="text-slate-100 mt-6 text-sm md:text-lg font-light max-w-xl font-inter leading-relaxed drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
            Take a deep dive into how we engineer digital dominance, crafting high-performance campaigns and platforms that refuse to settle.
          </p>
