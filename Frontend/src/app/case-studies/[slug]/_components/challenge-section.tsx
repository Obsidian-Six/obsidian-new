...
export default function ChallengeSection({
  ...
  return (
    <section className="relative bg-white overflow-hidden py-12 md:py-15">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-16">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-16">
          ...
          >
            <span className="text-black font-bold tracking-[0.4em] uppercase text-[10px] block mb-8">
              02 — The Objectives
            </span>
            <h2 className="text-4xl md:text-[5rem] font-light text-black tracking-tighter leading-none uppercase mb-12">
              The <span className=" font-serif text-black/30">Challenge</span>
            </h2>

            <p className="text-2xl md:text-3xl font-light text-black leading-[1.15] tracking-tight max-w-5xl">
              {challenge.data}
            </p>
          </motion.div>
        </div>
