    ...
    <div className="bg-white min-h-screen font-sans">
      ...
      */}
            <div className="lg:sticky lg:top-28 bg-[#F9F9FB] p-6 md:p-4 rounded-3xl border border-slate-200 shadow-sm 
                      ...
                      scrollbar-thin scrollbar-thumb-[#024787] scrollbar-track-slate-100">

              <h3 className="text-2xl md:text-3xl font-extrabold text-[#024787] mb-4 md:mb-6 tracking-tight sticky top-0 bg-[#F9F9FB] pb-2 z-10">
