...
export default function AboutUs() {
  ...
  // Parallax for background glows - Adjusted for light background
  ...
  const fadeInUp = {
    ...
    // Cast ease to `any` because Framer Motion's TS types don't accept numeric bezier arrays by default
  ...
  const teamCategories = [
    {
      title: "Strategy & Leadership",
      desc: "Our strategic thinkers bring clarity and a growth-driven mindset to guide every project toward impactful results.",
      image: "/StratergyTeamcrop1.jpeg", // Add your image path here
      gradient: "from-blue-500/20"
    },
    {
      title: "Creative & Design",
      desc: "Designers specializing in branding, UI/UX, and motion graphics craft visuals that are purposeful.",
      image: "/creativecrop.jpeg", // Add your image path here
      gradient: "from-purple-500/20"
    },
    {
      title: "Technology & Dev",
      desc: "Our developers build fast, reliable, and scalable digital experiences from websites to custom apps.",
      image: "/developerscrop.jpeg", // Add your image path here
  ...
  return (
    // Changed to light background: #F8F9FA
    <section id="aboutus" className="relative bg-[#F8F9FA] text-slate-900 py-16 md:py-24 overflow-hidden">
      ...
      <motion.div
        style={{ y: yGlow1 }}
        className="absolute top-0 right-[-10%] w-[500px] h-[500px] bg-blue-400/5 blur-[120px] rounded-full z-0"
      />
      <motion.div
        style={{ y: yGlow2 }}
        className="absolute bottom-0 left-[-10%] w-[600px] h-[600px] bg-purple-400/5 blur-[120px] rounded-full z-0"
      />
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-6 relative z-10">
        ...
        <div className="mt-20 md:mt-32">
          <MotionDiv {...fadeInUp} className="mb-10 md:mb-16">
            <span className="text-xs tracking-[0.3em] uppercase text-blue-600 font-bold">01 // Our Squad</span>
              ...
              <div className="flex items-center gap-8">
                {[
                  ...
                  <a
                    key={social.name}
                    href={social.href}
                    className="text-xs uppercase tracking-widest font-black text-slate-400 hover:text-blue-600 transition-all duration-300"
                  >
                    {social.name}
                  </a>
                ))}
