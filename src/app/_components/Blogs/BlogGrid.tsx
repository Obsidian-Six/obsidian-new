                        ...
                        <article className="flex flex-col h-full">
                            ...
                            */}
                            ...
                            <div className="flex flex-col flex-grow px-1 md:px-0">
                                <p className="text-[#5A00EC] text-[10px] md:text-[11px] font-black uppercase tracking-[0.2em] mb-2 md:mb-3">
                                ...
                                <h2
                                    className="text-xl md:text-2xl font-bold text-slate-900 leading-[1.2] mb-3 transition-colors duration-300 group-hover:text-[#5A00EC]"
                                ...
                                <div className="mt-auto flex items-center text-sm font-bold text-black group-hover:text-[#5A00EC] transition-colors">
                                    <span className="inline-block border-b-2 border-[#5A00EC] transition-all group-hover:pr-4 pb-1">
                                        Read Story
                                    </span>
                                    <svg
