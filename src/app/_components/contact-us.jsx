...
const ContactUs = () => {
  return (
    <>
      ...
      />
      <div className="my-20">
        <div className="max-w-5xl mx-auto p-6 grid grid-cols-1 md:grid-cols-2 textmain gap-20">
          ...
          <div>
            <form className="space-y-4">
              ...
              <div>
                <button className="font-medium text-sm ml-auto px-5 py-2 text-white flex items-center justify-between gap-2 bg-[#5A00EC] my-6">
