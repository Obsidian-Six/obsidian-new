      ...
      {arr.map((ele, i) => (
        <SwiperSlide key={i} className="h-full w-full bg-[#d9d9d9]">
          ...
          <div className="relative text-color z-10 flex flex-col justify-center items-center h-full text-center max-w-4xl mx-auto md:p-0 sm:p-4 p-6 max-md:mt-10">
            ...
            // viewport={{ once: false }}
             className="text-6xl text-center font-light max-md:text-4xl max-sm:text-4xl">
              ...
              <div className="md:flex md:mt-6">
                ...
                <ReactTyped
                  strings={[" growth", " brand", " SEO"]}
                  typeSpeed={80} // Speed of typing
                  backSpeed={50} // Speed of deleting
                  loop // Runs animation in a loop
            ...
            transition={{duration:0.4 , delay:0.5 }}
             className="text-2xl textmain max-w-lg font-light mx-auto my-6 max-md:text-lg">
            ...
            <MotionDiv
             ...
             className="absolute bottom-20 -left-40 z-10 inter textmain grid justify-items-center">
              <div className="rotate-[270deg]">Scroll</div>
              <div className="w-[1px] h-20 bgmain mt-6" />
            </MotionDiv>
            ...
            <MotionDiv
             ...
             className="absolute top-52 -right-40 z-10 inter textmain grid justify-items-center">
              <div className="rotate-[270deg]">contact us</div>
              <div className="w-[0.5px] h-20 bgmain mt-10" />
              <div className="text-2xl textmain space-y-10 mt-10">
                <FaInstagram />
                <FaLinkedin />
                <FaWhatsapp />
              </div>
