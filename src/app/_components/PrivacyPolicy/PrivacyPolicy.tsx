...
export default function PrivacyPolicy() {
    ...
    return (
        <section id="privacy" className="scroll-mt-20">
            <div className="min-h-screen bg-white text-gray-900 selection:bg-[#5A00EC] selection:text-white">
                        ...
                        <div className="sticky top-12 space-y-2">
                            ...
                            {sections.map((section) => (
                                <a
                                    key={section.id}
                                    href={`#${section.id}`}
                                    className="block text-xs font-bold text-gray-500 hover:text-[#5A00EC] hover:bg-gray-50 transition-all py-3 px-4 rounded-xl border-l-2 border-transparent hover:border-[#5A00EC]"
                                >
                                    {section.title}
                                </a>
                            ))}
                            ...
                            <div className="mt-12 p-8 bg-black rounded-[2.5rem] text-white shadow-xl shadow-purple-500/10">
                                <p className="text-[10px] font-black text-[#5A00EC] uppercase tracking-[0.3em] mb-4">Navigation</p>
                                <div className="space-y-4">
                                    <Link href="/terms" className="text-lg font-black text-white hover:text-[#5A00EC] transition-colors flex items-center justify-between group">
                                        Terms <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                                    </Link>
                                    <div className="h-[1px] bg-white/10 w-full"></div>
                                    <Link href="/terms" className="text-lg font-black text-[#5A00EC] transition-colors flex items-center justify-between group">
                    ...
                    <main className="flex-1 prose prose-lg prose-headings:font-black prose-headings:tracking-tighter prose-headings:text-black prose-p:text-gray-600 prose-p:leading-relaxed prose-strong:text-black max-w-none">
                        ...
                        <section id="intro" className="scroll-mt-10">
                            ...
                            <p>
                                ...
                                <Link href="https://obsidiansix.com" className="text-[#5A00EC] font-bold mx-1 hover:underline">https://obsidiansix.com</Link>
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mt-8">
                                <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100">
                                    <h3 className="m-0 text-xl font-black mb-4 flex items-center gap-3">
                                        <UserCheck className="text-[#5A00EC]" /> Personal Data
                                    </h3>
                                ...
                                <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100">
                                    <h3 className="m-0 text-xl font-black mb-4 flex items-center gap-3">
                                        <Globe className="text-[#5A00EC]" /> Automatic Data
                                    </h3>
                                    <p className="m-0 text-sm font-medium leading-relaxed">
                            ...
                            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 list-none p-0">
                                {["Operate & improve services", "Respond to specific inquiries", "Send promotional updates", "Analyze usage trends", "Prevent fraud & enhance security"].map((item, idx) => (
                                    <li key={idx} className="flex items-center gap-4 bg-white border-2 border-gray-50 p-4 rounded-2xl font-bold text-sm shadow-sm">
                                        <ShieldCheck className="text-[#5A00EC] shrink-0" size={20} />
                                        {item}
                                    </li>
                                ))}
                            </ul>
                        ...
                        <section id="cookies" className="mt-20 scroll-mt-10">
                            <h2 className="text-3xl md:text-4xl flex items-center gap-4">
                                5. Cookies <Cookie className="text-[#5A00EC]" />
                            </h2>
                            <p>
                        ...
                        <section id="security" className="mt-20 scroll-mt-10">
                            <h2 className="text-3xl md:text-4xl flex items-center gap-4">
                                7. Data Security <Lock className="text-[#5A00EC]" />
                            </h2>
                            <p>
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <a href="mailto:info@obsidiansix.com" className="flex items-center gap-6 group cursor-pointer">
                                        <div className="w-16 h-16 bg-[#5A00EC] rounded-2xl flex items-center justify-center transition-transform group-hover:rotate-12">
                                            <Mail size={32} />
                                        </div>
                                        <div>
                                            <p className="text-[10px] uppercase font-black text-gray-500 tracking-widest">Email Support</p>
                                            <p className="text-lg md:text-xl font-black group-hover:text-[#5A00EC] transition-colors">info@obsidiansix.com</p>
                                        </div>
                                    </a>
                                    ...
                                    <a href="tel:+918085652729" className="flex items-center gap-6 group cursor-pointer">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg md:text-xl font-black group-hover:text-[#5A00EC] transition-colors">+91 80856 52729</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
