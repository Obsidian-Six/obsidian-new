    ...
    <>
      <div className="relative w-full md:h-screen h-[90vh] overflow-hidden">
        ...
        <div
          ...
          style={{ transform: `translateY(${offset * 0.5}px)` }} // Smoothly moves with scroll
        >
      ...
      <div id="case-study-section" className="bg-[#19183A] text-white py-20">
        <div className="w-[80%] mx-auto poppins">
          ...
          >
            <p className="h-2.5 w-2.5 bg-[#5A00EC]" /> Case Study - Pachmarhi Ayurveda
          </div>
          <p
          ...
          >
            How We Transformed a Legacy Ayurveda Brand into a
