            ...
            >
              <div className="grid md:grid-cols-2 gap-8 md:gap-32 items-center">
                <div className="relative">
                  ...
                  <h3 className="text-3xl md:text-5xl font-light text-[#19183A] leading-tight tracking-tight group-hover:text-[#5A00EC] transition-colors duration-500">
                    {item.name}
                  </h3>
                </div>
              ...
              <motion.div 
                ...
                className="bg-slate-100 h-[1px] mt-12 group-hover:bg-[#5A00EC]/30 transition-colors duration-500 origin-left" 
              />
            </motion.div>
          ))}
        </div>
