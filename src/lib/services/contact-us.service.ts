import type ContactUs from "../models/contact-us.interface";
 ...
 * @param contactUs - The contact us form data.
 */
async function sendEmailViaFormSubmit(contactUs: ContactUs): Promise<void> {
 ...
 * @param contactUs - The contact us form data.
 */
async function sendContactUsToGAS(contactUs: ContactUs): Promise<void> {
